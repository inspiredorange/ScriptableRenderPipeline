...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    public class GPUCopy
    {
        ...
        public void SampleCopyChannel_xyzw2x(CommandBuffer cmd, RTHandleSystem.RTHandle source, RTHandleSystem.RTHandle target, RectInt rect)
        {
            ...
            Debug.Assert(slices == source.rt.volumeDepth);
            Debug.Assert(slices == target.rt.volumeDepth);

            SampleCopyChannel(cmd, rect, _Source4, source, _Result1, target, slices, k_SampleKernel_xyzw2x_8, k_SampleKernel_xyzw2x_1);
        }
    }
}

...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class GBufferManager : MRTBufferManager
    {
        ...
        public override void CreateBuffers()
        {
            ...
            {
                m_RTs[gbufferIndex] = RTHandles.Alloc(Vector2.one, colorFormat: rtFormat[gbufferIndex], filterMode: FilterMode.Point, xrInstancing: true, name: string.Format("GBuffer{0}", gbufferIndex), enableRandomWrite: enableWrite[gbufferIndex]);
        ...
        public override void BindBufferAsTextures(CommandBuffer cmd)
        {
            ...
            if (m_LightLayers >= 0)
                ...
                cmd.SetGlobalTexture(HDShaderIDs._LightLayersTexture, HDUtils.GetWhiteTexture2DX()); // This is never use but need to be bind as the read is inside a if
        }

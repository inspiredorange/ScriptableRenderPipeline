...
RW_TEXTURE2DX(unorm float, _DecalHTile); // DXGI_FORMAT_R8_UINT is not supported by Unity
#else
RW_TEXTURE2DX(float, _DecalHTile); // DXGI_FORMAT_R8_UINT is not supported by Unity
#endif
TEXTURE2DX(_DecalHTileTexture);

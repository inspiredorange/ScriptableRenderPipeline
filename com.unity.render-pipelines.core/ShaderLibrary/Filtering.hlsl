...
#define UNITY_FILTERING_INCLUDED
    ...
    // XRTODO: not very clean, find another way to deal with this
    #ifdef SHADEROPTIONS_USE_ARRAY_FOR_TEXTURE2DX
        #error Texture2DX.hlsl must be included before Filtering.hlsl
    #endif
